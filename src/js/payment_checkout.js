...
(function (root, factory) {
  ...
  function Modal(options) {
    ...
    this.SERVER_LOCAL_URL = "http://localhost:8000";
  ...
  Modal.prototype.open = function (orderRequest) {
    ...
    if (orderRequest['order_taxable_amount'] !== undefined) {
      params['order']['taxable_amount'] = orderRequest['order_taxable_amount'];
    }

    if (orderRequest['order_tax_percentage'] !== undefined) {
      params['order']['tax_percentage'] = orderRequest['order_tax_percentage'];
    }
